        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Ubah Berita</strong>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.news.update', $edit->slug)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <input id="title" name="title" type="text" class="form-control" aria-required="true"
                                aria-invalid="false" value="{{$edit->title}}">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="image" name="image" type="file" class="form-control" aria-required="true"
                                aria-invalid="false" value="{{$edit->image}}">
                        </div>
                        <div class="form-group">
                            <label for="content" class="control-label mb-1">Konten</label>
                            <textarea id="default-editor" id="content" name="content">
                                {!! $edit->content !!}
                            </textarea>
                        </div>
                        <div class="form-group">
