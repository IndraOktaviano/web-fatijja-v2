        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Daftar Slide</strong>
                </div>
                <div class="card-body">
                    <form

                        @if (isset($edit))
                            action="{{ route('admin.slide.update', $edit->id) }}"
                        @else
                            ...
                            @foreach ($slides as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{ $item->id }}" action="{{route('admin.slide.destroy', $item->id)}}" method="post" class="mx-0">
                                            @method('delete')
                                            @csrf
                                        </form>
                                    </td>
